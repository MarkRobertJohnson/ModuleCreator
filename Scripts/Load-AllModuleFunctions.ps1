...
foreach($functionPath in $functionPaths) {    # load all functions from files in the "Functions" folder, by convention, only functions matching file names are exported
