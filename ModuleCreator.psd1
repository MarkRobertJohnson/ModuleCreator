#
# Module manifest for module 'ModuleCreator'
...
Description = 'A module to simplify the creation of templated modules'

# Private data to pass to the module specified in RootModule/ModuleToProcess. This may also contain a PSData hashtable with additional module metadata used by PowerShell.
PrivateData = @{
    PSData = @{
         Tags = @('template','powershell','automate','module')
         LicenseUri = 'https://raw.githubusercontent.com/MarkRobertJohnson/ModuleCreator/master/LICENSE'
